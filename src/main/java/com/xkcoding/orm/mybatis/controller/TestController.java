...
import com.xkcoding.orm.mybatis.common.ApiResponse;
...
public class TestController {
	...
	@ApiOperation(value = "查询所有用户（DONE）", notes = "备注")
	@ApiImplicitParams({})
	public ApiResponse<List<User>> queryStudentBySno() {
		List<User> lstUser = this.userService.selectAllUser();
		return ApiResponse.<List<User>> builder().code(200).message("操作成功").data(lstUser).build();
	}
